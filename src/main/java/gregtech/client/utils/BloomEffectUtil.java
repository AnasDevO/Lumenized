...
//        }
        ...
        if (ShaderManager.isOptifineShaderPackLoaded() || !LumenizedConfig.emissiveTexturesBloom) {
        ...
        BloomEffect.strength = (float) LumenizedConfig.strength;
        BloomEffect.baseBrightness = (float) LumenizedConfig.baseBrightness;
        BloomEffect.highBrightnessThreshold = (float) LumenizedConfig.highBrightnessThreshold;
        BloomEffect.lowBrightnessThreshold = (float) LumenizedConfig.lowBrightnessThreshold;
        BloomEffect.step = (float) LumenizedConfig.step;
        // TODO BloomStyle.
        switch (LumenizedConfig.bloomStyle) {
